...
/**
 * <h2>JsonValue — Leaf Node for Primitives</h2>
 *
 * <p>Represents a JSON scalar value: {@link String}, {@link Number},
 * {@link Boolean}, or {@code null}. Implemented as a Java record for
 * structural immutability and value-based equality.</p>
 *
 * <h3>Supported Types:</h3>
 * <ul>
 *   <li>{@code null}  → JSON {@code null}</li>
 *   <li>{@link String}  → JSON {@code "text"}</li>
 *   <li>{@link Number}  → JSON {@code 42}, {@code 3.14}</li>
 *   <li>{@link Boolean} → JSON {@code true} / {@code false}</li>
 * </ul>
 *
 * <h3>Examples:</h3>
 * <pre>{@code
...
public record JsonValue(Object value) implements JsonNode {
     ...
     * Numbers and booleans are written as-is. {@code null} → {@code null}.
     */
    @Override
