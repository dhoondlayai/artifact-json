...
/**
 * <h2>JsonMappingException â€” POJO Serialization / Deserialization Failure</h2>
 *
 * <p>Thrown when {@code CustomObjectMapper} or {@code FastObjectMapper}
 * cannot map between a Java object and a {@link io.github.dhoondlayai.artifact.json.model.JsonNode}.</p>
 *
 * <h3>Common causes:</h3>
 * <ul>
