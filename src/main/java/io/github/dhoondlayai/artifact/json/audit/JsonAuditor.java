package io.github.dhoondlayai.artifact.json.audit;
...
/**
 * ðŸ•µï¸ JSON Audit Trail: Tracks and logs every modification to the JSON tree.
...
public class JsonAuditor {
    ...
    public void printReport() {
        System.out.println("\nðŸ“œ --- JSON MODIFICATION AUDIT REPORT ---");
