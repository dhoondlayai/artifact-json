...
/**
 * <h2>JsonMerger â€” Deep Merge Utility</h2>
 *
 * <p>Merges two {@link JsonNode} trees with configurable conflict resolution.
 * All merges produce a <b>new</b> tree â€” original inputs are never mutated.</p>
 *
 * <h3>Merge rules:</h3>
 * <ul>
 *   <li>{@link JsonObject} + {@link JsonObject} â†’ keys merged recursively; right-side wins conflicts</li>
 *   <li>{@link JsonArray} + {@link JsonArray} â†’ arrays concatenated (all left elements, then all right)</li>
 *   <li>Any other combination â†’ right-side value replaces left</li>
 * </ul>
 *
 * <h3>Examples:</h3>
 * <pre>{@code
