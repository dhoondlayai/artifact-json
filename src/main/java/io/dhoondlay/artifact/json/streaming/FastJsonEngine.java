...
/**
 * <h2>FastJsonEngine — Zero-Copy, RFC 8259 Compliant JSON Parser</h2>
 *
 * <p>
 ...
 *       objects</li>*
 *       <li>Single-pass parsing—O(n)time,O(depth)stack space</li>*
...
public final class FastJsonEngine {
     ...
     * Zero-copy path — converts to String only for compatibility.
     *
