package io.dhoondlay.artifact.json.convert;

import io.dhoondlay.artifact.json.exception.JsonConversionException;
...
/**
 * <h2>JsonConverter — Unified Conversion Facade</h2>
 *
 * <p>
 ...
 * 
 * <pre>
 *   JSON → String (compact, pretty, minified)
 *   JSON → CSV
 *   JSON → XML
 *   JSON → YAML
